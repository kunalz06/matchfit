    ...
    <div>
      ...
      <div className="container" style={{ textAlign: 'center' }}>
        <div className="card" style={{ maxWidth: '800px', margin: '0 auto', padding: '40px' }}>
          <h2 style={{ color: '#b11226' }}>Welcome to Our Studio</h2>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '20px', marginBottom: '40px' }}>
            <div style={{ padding: '20px', background: '#f9f9f9', borderRadius: '10px' }}>
              ...
              <p style={{ fontSize: '0.9rem', color: '#777' }}>Precision in every needle stroke.</p>
            </div>
            <div style={{ padding: '20px', background: '#f9f9f9', borderRadius: '10px' }}>
              <h3 style={{ margin: 0 }}>Fast Alterations</h3>
              <p style={{ fontSize: '0.9rem', color: '#777' }}>Quick fixes for the perfect silhouette.</p>
            </div>
            <div style={{ padding: '20px', background: '#f9f9f9', borderRadius: '10px' }}>
              <h3 style={{ margin: 0 }}>Custom Design</h3>
              <p style={{ fontSize: '0.9rem', color: '#777' }}>Unique styles crafted from your vision.</p>
            </div>
          </div>
        ...
        <button
          onClick={() => navigate('/')}
          style={{ background: 'none', color: '#999', boxShadow: 'none', marginTop: '20px' }}
        >
          ← Back to Main Page
        </button>
      </div>
